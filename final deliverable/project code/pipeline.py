...
model2 = load_model("static/model/model2.h5")
model3_loc = load_model('static/model/model3_loc.h5')
model3_sev = load_model('static/model/model3_sev.h5')
with open('static/model/vgg16_cat_list.pk', 'rb') as f:
    cat_list = pk.load(f)
